...
/// 開始時に呼び出す
///-------------------------------------------///
void MoveState::Enter(Player* player, Camera* camera) {
	// 引数の取得
	player_ = player;
	camera_ = camera;
...
/// 更新時に呼び出す
///-------------------------------------------///
void MoveState::Update(Player * player, Camera * camera) {
	// 引数の取得
	player_ = player;
	camera_ = camera;
